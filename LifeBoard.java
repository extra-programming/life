...
class LifeBoard extends JPanel implements MouseListener {
    ...
    */
    ...
    @Deprecated LifeBoard(Component parent, Rules newRules, boolean fill) throws ArrayIndexOutOfBoundsException {
        this(DimensionsInputDialog.showDialog(parent), newRules, fill);
    }
    
     @Deprecated LifeBoard(Component parent, Rules newRules, boolean fill, String defaultValue) throws ArrayIndexOutOfBoundsException {
        this(DimensionsInputDialog.showDialogWithDefault(parent, defaultValue), newRules, fill);
    }
    
    @Deprecated LifeBoard(Component parent, String dimensionMessage, Rules newRules, boolean fill) throws ArrayIndexOutOfBoundsException {
